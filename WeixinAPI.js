...
//文本消息
API.prototype.sendText = function (touser, toparty, text, callback) {
 ...
 */
API.prototype._sendText = function (touser, toparty, text, callback) {
...
//发送图文消息
API.prototype.sendNews = function (touser, toparty, articles, callback) {
    if(touser.length > 0 || toparty.length > 0){
 ...
 */
API.prototype._sendNews = function (touser, toparty, articles, callback) {
  var url = this.prefix + 'message/send?access_token=' + this.token.accessToken;
